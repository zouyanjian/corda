...
object NodeInterestRates {
    ...
    class Oracle(private val services: AppServiceHub) : SingletonSerializeAsToken() {
        ...
        private fun addDefaultFixes() {
            knownFixes = parseFile(IOUtils.toString(NodeInterestRates::class.java.classLoader.getResourceAsStream("net/corda/irs/simulation/example.rates.txt"), Charsets.UTF_8.name()))
        }
    }
