...
class HibernateConfiguration(
        ...
        private val cordappClassLoader: ClassLoader? = null
) {
    companion object {
    ...
    private fun buildSessionFactory(config: Configuration, metadataSources: MetadataSources, tablePrefix: String, cordappClassLoader: ClassLoader?): SessionFactory {
        ...
        if (cordappClassLoader != null) {
            config.standardServiceRegistryBuilder.addService(ClassLoaderService::class.java, ClassLoaderServiceImpl(cordappClassLoader))
        }
