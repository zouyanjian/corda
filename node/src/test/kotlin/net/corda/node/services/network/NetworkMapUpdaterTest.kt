...
class NetworkMapUpdaterTest {
    ...
    private val updater = NetworkMapUpdater(networkMapCache, fileWatcher, networkMapClient)
    ...
    private fun createMockNetworkMapClient(): NetworkMapClient {
        return mock {
            ...
            on { getNetworkMap() }.then {
                NetworkMapResponse(NetworkMap(nodeInfoMap.keys.toList(), SecureHash.randomSHA256()), cacheExpiryMs.millis)
            }
