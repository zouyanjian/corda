...
class NodeMessagingClient(override val config: NodeConfiguration,
    ...
    fun start(rpcOps: RPCOps, userService: RPCUserService) {
        state.locked {
            ...
            rpcDispatcher = createRPCDispatcher(rpcOps, userService, config)
        }
    }
    ...
    private fun createRPCDispatcher(ops: RPCOps, userService: RPCUserService, config: NodeConfiguration) =
            object : RPCDispatcher(ops, userService, config) {
