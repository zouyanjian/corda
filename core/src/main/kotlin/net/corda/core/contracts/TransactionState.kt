...
data class TransactionState<out T : ContractState> @JvmOverloads constructor(
        ...
        val data: T,
        /**
         * The contract that will verify this state - this will be a class name that will be created via reflection.
         ...
         * send across, and run, from the network from within a sandbox environment.
         *
